...
class EnvironmentReader {
     ...
     */
    static let isTestFlight = Bundle.main.appStoreReceiptURL?.lastPathComponent == "sandboxReceipt" && !EnvironmentReader.isDebug
    ...
    */
     ...
     */
    static func configuration(testValue: BuildType? = nil) -> BuildType {
    ...
    */
    static var isJailbroken: Bool {
        ...
        guard !EnvironmentReader.isSimulator else {
            return false
        }
