//
//  OLDServerConfigurationViewModel.swift
//  Scyther
//
...
internal class OLDServerConfigurationViewModel {
    // MARK: - Data
...
//        environmentSection.rows = ConfigurationSwitcher.instance.configurations.sorted(by: { $0.id < $1.id }).map({ checkmarkRow(identifier: $0.id) })
...
extension OLDServerConfigurationViewModel {
    var title: String {
