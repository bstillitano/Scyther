...
struct UserDefaultsArrayView: View {
    ...
    private func arrayRow(index: Int, element: Any) -> some View {
        let displayValue = UserDefaultsSwiftUIViewModel.displayString(for: element)
        let valueType = UserDefaultsSwiftUIViewModel.detectValueType(element)
...
struct UserDefaultsDictionaryView: View {
    ...
    private func dictionaryRow(key rowKey: String, value: Any) -> some View {
        let displayValue = UserDefaultsSwiftUIViewModel.displayString(for: value)
        let valueType = UserDefaultsSwiftUIViewModel.detectValueType(value)
