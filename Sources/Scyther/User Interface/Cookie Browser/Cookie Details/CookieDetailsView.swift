...
struct CookieDetailsView: View {
    ...
    @StateObject private var viewModel: CookieDetailsSwiftUIViewModel

    init(cookie: HTTPCookie) {
        self.cookie = cookie
        _viewModel = StateObject(wrappedValue: CookieDetailsSwiftUIViewModel(cookie: cookie))
    }
...
class CookieDetailsSwiftUIViewModel: ViewModel {
