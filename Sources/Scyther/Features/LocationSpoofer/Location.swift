...
extension Location {
    ...
    static let sydney = Location(id: "sydney",
                                 name: "Sydney, Australia",
                                 latitude: -33.8688,
                                 longitude: 151.2093)
    static let helsinki = Location(id: "helsinki",
                                   name: "Helsinki, Finland",
                                   latitude: 60.1699,
                                   longitude: 24.9384)
    static let santiago = Location(id: "santiago",
                                   name: "Santiago, Chile",
                                   latitude: -33.4489,
                                   longitude: -70.669)
    static let rio = Location(id: "rio",
                              name: "Rio de Janeiro, Brazil",
                              latitude: -22.9068,
                              longitude: -43.1729)
    static let denver = Location(id: "denver",
                                 name: "Denver, USA",
                                 latitude: 39.7392,
                                 longitude: -104.9903)
    static let cincinatti = Location(id: "cincinatti",
                                     name: "Cincinnati, USA",
                                     latitude: 39.1031,
                                     longitude: -84.5120)
    static let moscow = Location(id: "moscow",
                                 name: "Moscow, Russia",
                                 latitude: 55.7558,
                                 longitude: 37.6173)
    static let tokyo = Location(id: "tokyo",
                                name: "Tokyo, Japan",
                                latitude: 35.6762,
                                longitude: 139.6503)
    static let palermo = Location(id: "palermo",
                                  name: "Palermo, Italy",
                                  latitude: 38.1157,
                                  longitude: 13.3615)
    static let bogota = Location(id: "bogota",
                                 name: "Bogotá, Colombia",
                                 latitude: 4.7110,
                                 longitude: -74.0721)
    static let berlin = Location(id: "berlin",
                                 name: "Berlin, Germany",
                                 latitude: 52.5200,
                                 longitude: 13.4050)
    static let oslo = Location(id: "oslo",
                               name: "Oslo, Norway",
                               latitude: 59.9139,
                               longitude: 10.7522)
    static let nairobi = Location(id: "nairobi",
                                  name: "Nairobi, Kenya",
                                  latitude: -1.2921,
                                  longitude: 36.8219)
    static let marseille = Location(id: "maresille",
    ...
    static let newYork = Location(id: "newYork",
                                  ...
                                  latitude: 40.7128,
                                  longitude: -74.0060)
    static let mumbai = Location(id: "mumbai",
                                 name: "Mumbai, India",
                                 latitude: 19.0760,
                                 longitude: 72.8777)
    static let sanFrancisco = Location(id: "sanFranciso",
                                       name: "San Francisco, USA",
                                       latitude: 37.7749,
                                       longitude: -122.4194)
    static let mexico = Location(id: "mexico",
                                 name: "Mexico City, Mexico",
                                 latitude: 19.435478,
                                 longitude: -99.136479)
    static let stJulians = Location(id: "stJulians",
                                    name: "St. Julian, Malta",
                                    latitude: 35.9181,
                                    longitude: 14.4883)
    static let valletta = Location(id: "valletta",
                                   name: "Valletta, Malta",
                                   latitude: 35.8989,
                                   longitude: 14.5146)
    static let stockholm = Location(id: "stockholm",
                                    name: "Stockholm, Sweden",
                                    latitude: 59.3293,
                                    longitude: 18.0686)
    static let lisbon = Location(id: "lisbon",
